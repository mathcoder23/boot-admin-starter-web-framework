...
<script>
import option from "@_framework/const/user/info";
export default {
  data () {
    return {
      type: "info",
      ...
      form: {
        img: 'https://pixabay.com/get/52e8dc4a4252ae14f1dc8460825668204022dfe05b52774c76287dd6/laguna-4899802_640.jpg?attachment',
        username: "admin",
        name: "admin",
        ms: "保护头发，人人有责",
